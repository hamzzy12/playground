import svgPaths from "./svg-fs1n22h272";
...
export default function Group() {
  return (
    <div className="relative size-full">
      ...
      <p className="absolute font-['ONE_Mobile_POP_OTF:Regular',sans-serif] inset-[71.73%_59.83%_10.38%_4.43%] leading-[1.5] not-italic text-[#492607] text-[18px] text-center whitespace-pre-wrap">보상 : 칭찬코인 +1</p>
      <p className="absolute font-['ONE_Mobile_POP_OTF:Regular',sans-serif] inset-[11.43%_42.66%_68.69%_23.27%] leading-[1.5] not-italic text-[#492607] text-[20px] whitespace-pre-wrap">구몬학습지 풀기</p>
      <p className="absolute font-['ONE_Mobile_POP_OTF:Regular',sans-serif] inset-[35.28%_21.61%_44.84%_23.27%] leading-[1.5] not-italic text-[#492607] text-[20px] whitespace-pre-wrap">p7~p15까지 할 수 있지?</p>
