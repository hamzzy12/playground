import svgPaths from "./svg-ochqehly6h";
...
export default function Component({ className }: { className?: string }) {
  return (
    <div className={className || "bg-white h-[846px] relative w-[393px]"} data-name="홈화면_나혼자">
      ...
      <div className="absolute contents left-[130px] top-[11px]">
        ...
        <p className="absolute font-['ONE_Mobile_POP_OTF:Regular',sans-serif] inset-[2.01%_46.06%_94.8%_51.15%] leading-[1.5] not-italic text-[18px] text-center text-white whitespace-pre-wrap">5</p>
      </div>
      <div className="absolute contents left-[16px] top-[11px]">
        ...
        <div className="absolute contents left-[16px] top-[11px]">
          ...
          <div className="absolute contents left-[16px] top-[11px]">
            <div className="absolute h-[39px] left-[16px] top-[17px] w-[45px]" data-name="image 30">
        ...
        <p className="absolute font-['ONE_Mobile_POP_OTF:Regular',sans-serif] inset-[2.36%_70.74%_94.44%_16.79%] leading-[1.5] not-italic text-[18px] text-center text-white">김햄찌</p>
      </div>
      <div className="absolute contents left-[16px] top-[319px]">
        ...
        <p className="absolute font-['ONE_Mobile_POP_OTF:Regular',sans-serif] inset-[50.6%_59.03%_46.19%_8.14%] leading-[1.5] not-italic text-[#492607] text-[18px] text-center whitespace-pre-wrap">보상 : 칭찬코인 +1</p>
        <p className="absolute font-['ONE_Mobile_POP_OTF:Regular',sans-serif] inset-[39.76%_43.26%_56.67%_25.45%] leading-[1.5] not-italic text-[#492607] text-[20px] whitespace-pre-wrap">구몬학습지 풀기</p>
        <p className="absolute font-['ONE_Mobile_POP_OTF:Regular',sans-serif] inset-[44.05%_23.92%_52.38%_25.45%] leading-[1.5] not-italic text-[#492607] text-[20px] whitespace-pre-wrap">p7~p15까지 할 수 있지?</p>
      ...
      <div className="absolute contents left-[16px] top-[479px]">
        <div className="absolute contents left-[16px] top-[479px]">
          ...
          <div className="absolute contents left-[16px] top-[479px]">
            ...
            <p className="absolute font-['ONE_Mobile_POP_OTF:Regular',sans-serif] inset-[69.52%_59.03%_27.26%_8.14%] leading-[1.5] not-italic text-[#492607] text-[18px] text-center whitespace-pre-wrap">보상 : 칭찬코인 +1</p>
            <p className="absolute font-['ONE_Mobile_POP_OTF:Regular',sans-serif] inset-[58.81%_40.97%_37.62%_25.45%] leading-[1.5] not-italic text-[#492607] text-[20px] whitespace-pre-wrap">태권도 학원 가기</p>
            <p className="absolute font-['ONE_Mobile_POP_OTF:Regular',sans-serif] inset-[63.09%_29.01%_33.34%_25.45%] leading-[1.5] not-italic text-[#492607] text-[20px] whitespace-pre-wrap">학원 갔다오는게 어때?</p>
      ...
      <div className="absolute contents left-[16px] top-[641px]">
        ...
        <div className="absolute contents left-[16px] top-[641px]">
          <div className="absolute contents left-[16px] top-[641px]">
            ...
            <p className="absolute font-['ONE_Mobile_POP_OTF:Regular',sans-serif] inset-[88.57%_59.03%_8.21%_8.14%] leading-[1.5] not-italic text-[#492607] text-[18px] text-center whitespace-pre-wrap">보상 : 칭찬코인 +1</p>
            <p className="absolute font-['ONE_Mobile_POP_OTF:Regular',sans-serif] inset-[78.09%_45.8%_18.34%_25.45%] leading-[1.5] not-italic text-[#492607] text-[20px] whitespace-pre-wrap">학교 숙제 하기</p>
            <p className="absolute font-['ONE_Mobile_POP_OTF:Regular',sans-serif] inset-[82.38%_33.84%_14.05%_25.45%] leading-[1.5] not-italic text-[#492607] text-[20px] whitespace-pre-wrap">학교 복습 빼먹지마~</p>
      ...
      <div className="absolute contents left-[-1px] top-[799px]">
        <div className="absolute h-[46px] left-[-1px] top-[799px] w-[134px]">
        ...
        <div className="absolute h-[26px] left-[37px] top-[811px] w-[57px]" data-name="image 47">
      ...
      <div className="absolute h-[26px] left-[162px] top-[811px] w-[60px]" data-name="image 48">
        <img alt="" className="absolute inset-0 max-w-none object-cover opacity-30 pointer-events-none size-full" src={imgImage50} />
      </div>
      <div className="absolute contents left-[16px] top-[260px]">
        ...
        <p className="absolute font-['ONE_Mobile_POP_OTF:Regular',sans-serif] inset-[31.91%_47.07%_64.89%_8.14%] leading-[1.5] not-italic text-[18px] text-center text-white">1월 25일(토) 오늘의 미션</p>
      </div>
      ...
      <div className="absolute contents left-[43px] top-[76px]">
        ...
        <p className="absolute font-['ONE_Mobile_POP_OTF:Regular',sans-serif] inset-[10.28%_61.07%_86.52%_16.03%] leading-[1.5] not-italic text-[#291608] text-[18px]">오늘은 몇점?</p>
      </div>
