import svgPaths from "./svg-disegqpe5s";
...
export default function ParentHomeScreenTsx({ className }: { className?: string }) {
  return (
    <div className={className || "bg-white h-[846px] relative w-[393px]"} data-name="ParentHomeScreen.tsx">
