...
export default function Component({ className }: { className?: string }) {
  return (
    <div className={className || "bg-[#6e8f3b] h-[852px] relative w-[393px]"} data-name="상품올리기">
      ...
      <p className="absolute font-['ONE_Mobile_POP_OTF:Regular',sans-serif] inset-[59.86%_55.47%_36.97%_10.43%] leading-[1.5] not-italic text-[18px] text-[rgba(255,255,255,0.3)]">칭찬코인 개수 입력</p>
      ...
      <div className="absolute contents left-[20px] top-[193px]">
        <div className="absolute bg-[#733e14] border-4 border-[#cb721e] border-solid h-[60px] left-[20px] rounded-[8px] top-[193px] w-[169px]" />
        <div className="absolute bg-[#733e14] border-4 border-[#cb721e] border-solid h-[60px] left-[204px] rounded-[8px] top-[193px] w-[169px]" />
        <p className="absolute font-['ONE_Mobile_POP_OTF:Regular',sans-serif] inset-[24.65%_68.19%_72.18%_10.43%] leading-[1.5] not-italic text-[18px] text-[rgba(255,255,255,0.3)]">미션 시작일</p>
        <p className="absolute font-['ONE_Mobile_POP_OTF:Regular',sans-serif] inset-[24.65%_22.14%_72.18%_56.74%] leading-[1.5] not-italic text-[18px] text-[rgba(255,255,255,0.3)]">미션 완료일</p>
      </div>
