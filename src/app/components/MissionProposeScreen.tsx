...
export default function MissionProposeScreen() {
  ...
  return (
    <div className="min-h-screen w-full flex justify-center bg-gray-100">
      <div className="h-[852px] w-[393px] overflow-y-auto">
        <div className="bg-[#6e8f3b] h-[1004px] relative w-[393px]" data-name="미션제안하기">
          ...
          {(['1회', '매일', '매주', '매월'] as FrequencyType[]).map((freq, i) => {
            ...
            return (
              ...
              >
                ...
                <p className={`absolute inset-0 flex items-center justify-center font-['ONE_Mobile_POP_OTF:Regular',sans-serif] leading-[1.5] not-italic text-[18px] ${isSelected ? 'text-[#492607]' : 'text-[rgba(255,255,255,0.3)]'}`}>{freq}</p>
              </div>
            );
          })}
          ...
          >
            ...
            <p className="absolute inset-0 flex items-center justify-center font-['ONE_Mobile_POP_OTF:Regular',sans-serif] leading-[1.5] not-italic text-[#492607] text-[18px]">미션 만들기</p>
          </button>
          ...
          >
            ...
            <p className="absolute inset-0 flex items-center justify-center font-['ONE_Mobile_POP_OTF:Regular',sans-serif] leading-[1.5] not-italic text-[#d68641] text-[18px]">나중에</p>
          </button>
        </div>
      </div>
