  ...
  return (
    ...
    >
      <div className="absolute contents inset-0">
        ...
        <p className="absolute font-['ONE_Mobile_POP_OTF:Regular',sans-serif] inset-[24%_17.57%_22%_9.06%] leading-[1.5] not-italic text-[#c5afa5] text-[18px] w-full text-center flex items-center justify-center h-full top-0 left-0">
          {value || "관계가 어떻게 되요?"}
        </p>
      </div>
    </div>
...
export default function InvitationSignupScreen({ className, onSignup }: { className?: string; onSignup?: () => void }) {
  const [showRelationshipModal, setShowRelationshipModal] = useState(false);
  const [relationship, setRelationship] = useState("");

  return (
    <div className={className || "bg-[#6f8f3b] h-[852px] relative w-[393px] mx-auto overflow-hidden"} data-name="초대_회원가입">
      ...
      >
        <div className="absolute contents inset-0">
          ...
          <p className="absolute font-['ONE_Mobile_POP_OTF:Regular',sans-serif] inset-[24%_41.23%_22%_41.23%] leading-[1.5] not-italic text-[#492607] text-[18px] text-center w-full flex items-center justify-center h-full top-0 left-0">신규가입</p>
        </div>
      </div>
      ...
      <div className="absolute h-[50px] left-[97px] top-[433px] w-[199px]" data-name="시작버튼">
        <div className="absolute contents inset-0">
          <div className="absolute bg-[#7b3a00] inset-0 rounded-[10px]" />
          <p className="absolute font-['ONE_Mobile_POP_OTF:Regular',sans-serif] inset-[24%_17.57%_22%_9.06%] leading-[1.5] not-italic text-[#c5afa5] text-[18px] w-full text-center flex items-center justify-center h-full top-0 left-0">이름 입력</p>
        </div>
      </div>
      
      <p className="absolute font-['ONE_Mobile_POP_OTF:Regular',sans-serif] inset-[38.73%_21.88%_58.1%_20.61%] leading-[1.5] not-italic text-[18px] text-center text-white w-full flex items-center justify-center top-[330px] left-0">미션놀이터에 오신것을 환영해요</p>
