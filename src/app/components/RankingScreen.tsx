...
// Podium badge PNG images (numbers baked in)
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#1a1a2e]">
      <div className="relative w-[393px] h-[852px] overflow-hidden">
        ...
        {/* === PODIUM (absolute positioned from Figma coords) === */}
        ...
        {/* Crown (above 1st place) - rendered after profiles to appear on top */}
        ...
        {/* Star decorations - rendered after profiles to appear on top */}
        ...
        <div className="absolute left-0 top-[803px] w-[393px] h-[49px] bg-[#311d0c]">
          {/* Active indicator for ranking tab */}
