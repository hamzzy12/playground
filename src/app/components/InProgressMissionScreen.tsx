...
import imgImage53 from "figma:asset/5661db341ca257993e2c7bb556289fc77234882e.png";
import imgImage54 from "figma:asset/7717fbadfaff2519242403e5e5201a7517a295a2.png";
import MissionCelebrationPopup from "./MissionCelebrationPopup";
  ...
  return (
    <div className="min-h-screen w-full flex justify-center bg-gray-100">
      <div className="bg-[#6e8f3b] h-[852px] relative w-[393px]" data-name="진행중미션">
        ...
        <div className="absolute h-[36px] left-[130px] top-[62px] w-[136px]">
          ...
          >
            <div className="bg-[#733e14] border-4 border-[#cb721e] border-solid rounded-[8px] size-[78px] flex items-center justify-center">
              <div className="size-[39px]">
                <img alt="" className="w-full h-full object-cover" src={imgImage54} />
              </div>
            </div>
          </div>
        ...
        {/* 나중에 버튼 */}
        <button
          className="absolute h-[50px] left-[16px] top-[752px] w-[173px] cursor-pointer active:scale-95 transition-transform"
          onClick={handleLater}
        >
        ...
        {/* 미션완료 버튼 */}
        <button
          className="absolute h-[50px] left-[204px] top-[752px] w-[173px] cursor-pointer active:scale-95 transition-transform"
